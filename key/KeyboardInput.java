			...
			if (s.getId() == ID.player) {
				...
				case KeyEvent.VK_SPACE:
					if (true == !Fire) {
						...
						// facing left
						case 0: 
							Main.handler.addSuper(new Bullet(s.getX() - 15, s.getY()+28, 24, 10, ID.bullet, false, Main.handler, s.facing));
							keyReleased(e);
							Fire = true;
							Main.gunshot.play();
							break;
						...
						// facing right
						case 1: 
							Main.handler.addSuper(new Bullet(s.getX() + s.getWIDTH()-20, s.getY()+28, 24, 10, ID.bullet, false, Main.handler, s.facing));
							keyReleased(e);
							Fire = true;
							Main.gunshot.play();
							break;
