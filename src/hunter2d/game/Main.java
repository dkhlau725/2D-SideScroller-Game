...
import hunter2d.Super.Player;
import hunter2d.Super.Super;
import hunter2d.View.WorldTextView;
import hunter2d.graphics.Menu;
import hunter2d.graphics.Sprite;
import hunter2d.graphics.SpriteSheet;
import hunter2d.key.KeyboardInput;
import hunter2d.key.MouseInput;
...
public class Main extends Canvas implements Runnable {
	...
	private static WorldTextView textView;
	...
	private void init() {
		...
		jump = new Sound("../../resources/jump.wav");
		gunshot = new Sound("../../resources/gunshot.wav");
		bird = new Sound("../../resources/bird.wav");
		death = new Sound("../../resources/death.wav");
		spikes = new Sound("../../resources/spike.wav");
		music = new Sound("../../resources/music.wav");

		textView = new WorldTextView(handler);
	}
