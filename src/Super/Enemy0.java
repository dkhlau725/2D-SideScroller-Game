...
public class Enemy0 extends Super{
	...
	//test
	/*public void b() {
		System.out.println("distance is" + distanceToPlayer());
	}*/
	...
	/*if distanceToPlayer is less than 50 and enemy is on the same y-level as player
	 * then an enemy will go in the direction of the player
	 */
	...
	//this method activates when enemy collides with player and reduces player's HP by 1
